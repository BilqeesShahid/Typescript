...
//import { purchaseTicket } from "./utils/inquirerPrompts.js";
 import { listAllEvents } from "./Services/eventManagement.js";
            ...
            case 'Purchase Ticket':
                case 'Purchase Ticket':
                    ...
                    if (selectedEvent) {
                        ...
                        while (!validQuantity) {
                            const response = await ticketQuantityPrompt(selectedEvent.ticketStock);
                            ticketQuantity = response.ticketQuantity;
                
                            if (ticketQuantity > 0 && ticketQuantity <= selectedEvent.ticketStock) {
                                validQuantity = true;
                            } else {
                                console.log("Invalid ticket quantity. Please enter a number between 1 and the available stock.");
                            }
                        }

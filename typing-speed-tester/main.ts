...
import{ passages} from "./typingTest.js";
import readline from "readline";
import { displayResults } from "./typingTest.js";
import { TestConfig } from "./typingTest.js";
...
const main= async()=> {
    ...
    const configureTest = async (): Promise<TestConfig> => {
        ...
        return { duration: answers.duration, difficulty: answers.difficulty as 'basic' | 'random' | 'technical' };
      };

...
export interface TestConfig {
  ...
  difficulty: 'basic' | 'random' | 'technical';
}
...
export const executeTest = async (config: TestConfig): Promise<TestResult> => {
...
const typingTest = async (duration: number, passage: string, userInput: string): Promise<TestResult> => {
...
export const displayResults = (result: TestResult): void => {
